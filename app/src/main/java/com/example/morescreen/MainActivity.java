...
public class MainActivity extends ListActivity {
    ...
    String[] things = {"Аргентина", "Бразилия", "Чили", "Колумбия", "РС(Якутия)"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>( this, android.R.layout.simple_expandable_list_item_1, things);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent intent5 = new Intent(MainActivity.this, Yakutia.class);
